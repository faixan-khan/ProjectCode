...
#SBATCH --error=w_9_m_8_n_15_nw_4_maebased #The .error file name
#SBATCH --output=w_9_m_8_n_15_nw_4_maebased #The .output file name
...
--master_addr=127.0.0.1 --master_port=29516 main_pretrain.py \
    --batch_size 256 \
    --accum_iter 4 \
    --output_dir /ibex/ai/project/c2090/lomar_plus_save/checkpoint/raven/mae_based_mask_0.8_neigh_15_wind_9_num_4_epochs_100 \
    --log_dir /ibex/ai/project/c2090/lomar_plus_save/logs/raven/mae_based_mask_0.8_neigh_15_wind_9_num_4_epochs_100 \
