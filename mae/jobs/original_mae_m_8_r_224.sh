...
#SBATCH --job-name=original_mae_m_8_r_224
#SBATCH --output=logs/original_mae_m_8_r_224
#SBATCH --error=mae_m_8_r_224.err #The .error file name
#SBATCH --output=mae_m_8_r_224.out #The .output file name
