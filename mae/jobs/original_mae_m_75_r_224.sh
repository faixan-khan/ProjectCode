...
--master_addr=127.0.0.1 --master_port=29517 main_pretrain.py \
    --batch_size 256 \
    --accum_iter 4 \
    --output_dir /ibex/ai/project/c2090/lomar_plus_save/checkpoint/raven/original_mae_m_75_r_224 \
    --log_dir /ibex/ai/project/c2090/lomar_plus_save/logs/raven/original_mae_m_75_r_224 \
