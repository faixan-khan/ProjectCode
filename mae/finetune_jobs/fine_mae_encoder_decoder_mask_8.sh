...
#SBATCH --error=m8.err #The .error file name
#SBATCH --output=m8.out #The .output file name
...
--master_addr=127.0.0.1 --master_port=29514 main_finetune.py \
    --batch_size 256 \
    --accum_iter 1 \
    --output_dir /ibex/ai/project/c2090/lomar_plus_save/checkpoint/finetuned_mae_encoder_with_decoder_mask_0.8_wind_7_100epoches \
    --log_dir /ibex/ai/project/c2090/lomar_plus_save/logs/finetuned_mae_encoder_with_decoder_mask_0.8_wind_7_100epoches \
    --model vit_base_patch16 \
    --finetune /ibex/ai/project/c2090/lomar_plus_save/checkpoint/mae_encoder_with_decoder_mask_0.8_wind_7_100epoches/checkpoint-99.pth \
    --epochs 100 \
