...
--master_addr=127.0.0.1 --master_port=29516 main_pretrain.py \
    --batch_size 256 \
    --accum_iter 4 \
    --output_dir /ibex/ai/project/c2090/lomar_plus_save/checkpoint/mae_encoder_with_decoder_mask_0.8_wind_7_100epoches \
    --log_dir /ibex/ai/project/c2090/lomar_plus_save/logs/mae_encoder_with_decoder_mask_0.8_wind_7_100epoches \
