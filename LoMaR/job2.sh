...
#SBATCH --job-name=mae_encoderonly_mask_0.85_wind_7_100epoches
#SBATCH --output=logs/mae_encoderonly_mask_0.85_wind_7_100epoches
...
--master_addr=127.0.0.1 --master_port=29516 main_pretrain_lomar.py \
    --batch_size 256 \
    --accum_iter 4 \
    --output_dir /ibex/ai/project/c2090/lomar_plus_save/checkpoint/mae_encoderonly_mask_0.85_wind_7_100linear_raven \
    --log_dir /ibex/ai/project/c2090/lomar_plus_save/logs/mae_encoderonly_mask_0.85_wind_7_100linear_raven \
