...
#SBATCH --job-name=fine_w_7_m_8_n_5_nw_1
#SBATCH --output=logs/fine_w_7_m_8_n_5_nw_1
#SBATCH --error=fine_w_7_m_8_n_5_nw_1.err #The .error file name
#SBATCH --output=fine_w_7_m_8_n_5_nw_1.out #The .output file name
...
--master_addr=127.0.0.1 --master_port=29514 main_finetune_lomar.py \
    --batch_size 256 \
    --accum_iter 1 \
    --output_dir /ibex/ai/project/c2090/lomar_plus_save/checkpoint/raven/finetuned_mae_encoderonly_mask_0.8_neigh_0.05_wind_7_num_1_epochs_100 \
    --log_dir /ibex/ai/project/c2090/lomar_plus_save/logs/raven/finetuned_mae_encoderonly_mask_0.8_neigh_0.05_wind_7_num_1_epoches_100 \
