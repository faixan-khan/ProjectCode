...
--master_addr=127.0.0.1 --master_port=29517 main_pretrain_lomar.py \
    --batch_size 256 \
    --accum_iter 4 \
    --output_dir /ibex/ai/project/c2090/lomar_plus_save/checkpoint/raven384/mae_encoderonly_mask_0.8_neigh_0_wind_9_num_4_epochs_100_r_384 \
    --log_dir /ibex/ai/project/c2090/lomar_plus_save/logs/raven384/mae_encoderonly_mask_0.8_neigh_0_wind_9_num_4_epoches_100_r_384 \
