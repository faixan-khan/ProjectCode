...
#SBATCH --job-name=r_448_w_9_m_8_n_0_nw_4
#SBATCH --output=logs/r_448_w_9_m_8_n_0_nw_4
#SBATCH --error=r_448_w_9_m_8_n_0_nw_4.err #The .error file name
#SBATCH --output=r_448_w_9_m_8_n_0_nw_4.out #The .output file name
