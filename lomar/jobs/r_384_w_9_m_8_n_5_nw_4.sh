...
#SBATCH --job-name=r_384_w_9_m_8_n_5_nw_4
#SBATCH --output=logs/r_384_w_9_m_8_n_5_nw_4
#SBATCH --error=r_384_w_9_m_8_n_5_nw_4.err #The .error file name
#SBATCH --output=r_384_w_9_m_8_n_5_nw_4.out #The .output file name
