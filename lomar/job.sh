...
--master_addr=127.0.0.1 --master_port=29517 main_pretrain_lomar.py \
    --batch_size 256 \
    --accum_iter 4 \
    --output_dir save/checkpoint/mae_encoderonly_mask_0.8_neigh_0.05_wind_7_100epoches_a100 \
    --log_dir save/logs/mae_encoderonly_mask_0.8_neigh_0.05_wind_7_100epoches_a100 \
